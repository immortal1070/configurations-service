...
import com.immortal.configurations.validation.validators.ExistConfigInstanceValidator;
/**
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = { ExistConfigInstanceValidator.class })
public @interface ExistConfigInstance
{
